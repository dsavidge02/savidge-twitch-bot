    ...
    return (
        <div className="creator-header-container">
            <div className="creator-header-brand-container">
                <Link to="/" className="creator-header-brand-link">Home</Link>
            </div>
            <div className="creator-header-links-container">
                {
                    !isAuth && (
                        <div className="creator-header-unprotected-links-container">
                            <Link to="/login" className="creator-header-link">Login</Link>
                            <Link to="/register" className="creator-header-link">Register</Link>
                        </div>
                    )
                }
                {   
                    isAuth && (
                        <div className="creator-header-protected-links-container">
                            <Link to="/users" className="creator-header-link">Profile</Link>
