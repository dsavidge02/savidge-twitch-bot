    ...
    return (
        <div className="creator-home-content">
            <div className="creator-home-header">
                ...
                <img className="creator-home-header-logo" src={mindMeleeLogo} alt={"Savidge Apps"} />
            </div>
